...
class Strategy(BaseStrategy):
    ...
    position = Position(pair, long_short_data, long_short_data)
    total_pnl = 0.0
...
config = RuntimeConfig(
    mode=runtime_mode,
    datasource_topics=[
        "cryptoquant|1h|eth/market-data/coinbase-premium-index?window=hour"
    ],
    ...
    api_key=config["3FOSdsLW7nQmT8X7a2nRFkBEIwnsQnkjauet8IdBzKB2QDN0"],
    api_secret=config["hiTXS8iyenJSJUivJ4Vw1C2e6zXRIZm5k6fU1Y6M1V90Ngtkf6hArUhREbAAdw76O4CQMTEP"],
    data_count=500,
    exchange_keys="./credentials-testnet.json",
)
